...
resource sqlServer 'Microsoft.Sql/servers@2023-08-01-preview' = {
  ...
  resource firewall 'firewallRules' = {
    ...
    properties: {
      ...
      // This is not sufficient, because we all want to all direct access from developer machine, for debugging purposes
...
resource sqlAzureConnectionStringSecret 'Microsoft.KeyVault/vaults/secrets@2023-07-01' = {
  parent: keyVault
